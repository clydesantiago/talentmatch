    ...
    return (
      <div class="m-5">
        <div class="group mx-2 mt-10 grid max-w-screen-md grid-cols-12 space-x-8 overflow-hidden rounded-lg border py-8 text-gray-700 shadow transition hover:shadow-lg sm:mx-auto">
          <a href="http://talentmatch.test/apply" class="order-2 col-span-1 mt-4 -ml-14 text-left text-gray-600 hover:text-gray-700 sm:-order-1 sm:ml-4">
          ...
          <div class="col-span-11 flex flex-col pr-8 text-left sm:pl-4">
            ...
            <a href="/apply" class="mb-3 overflow-hidden pr-7 text-lg font-semibold sm:text-xl"> {job.data.title} </a>
